...
Dual branch with auxiliary supervision $-$ dual branch without auxiliary supervision & +0.0034 & +0.0031 & 21/0/3 & [0.0023, 0.0047] & $3.93\times10^{-6}$ \\
\bottomrule
\end{tabular}
\end{table*}
...
\centering
\caption{Combining tissue-independent peptide--MHC scores with the human tissue-conditioned model score. The combination rule is learned on other folds, and all external scores were generated before this analysis.}
