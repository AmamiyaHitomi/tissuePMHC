...
Outputs are written to ``paper/tissuePMHC_latex_v9/figures``.  The script
...
PAPER = ROOT / "paper" / "tissuePMHC_latex_v9"
...
def _figure2_occurrence_balance_impl() -> list[dict[str, object]]:
    ...
    # Match the Human/Mouse rain colors in main-text Figure 2, using slightly
    # deeper shades so the solid bars retain sufficient visual weight.
    label0_color = "#2F669F"
    label1_color = "#C9544D"
    text_color = "#20242A"
    muted = "#5F6670"
